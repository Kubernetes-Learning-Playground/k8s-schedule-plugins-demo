...
// TestNodeResourceSchedulingName is the name of the plugin used in the Registry and configurations.
const TestNodeResourceSchedulingName = "test-node-resource-scheduler"

// Name returns name of the plugin. It is used in logs, etc.
func (alloc *Allocatable) Name() string {
	return TestNodeResourceSchedulingName
}
...
func NewAllocatable(allocArgs runtime.Object, h framework.Handle) (framework.Plugin, error) {
	...
	return &Allocatable{
		...
		resourceAllocationScorer: resourceAllocationScorer{
			Name:                TestNodeResourceSchedulingName,
